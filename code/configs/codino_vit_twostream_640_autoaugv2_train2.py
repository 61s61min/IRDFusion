...
data_root = '/root/autodl-fs/FLIR-align-3class-codetr/'
...
evaluation = dict(save_best='coco/bbox_mAP_50', interval=1, metric=['bbox'])
...
resume_from = '/root/autodl-tmp/codino_vit_twostream_640_autoaugv2_train2/latest.pth'

work_dir = '/root/autodl-tmp/codino_vit_twostream_640_autoaugv2_train2'