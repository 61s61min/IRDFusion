...
from .common import TransformerFusionBlock, TransformerFusionBlockForOnlyTir, NiNfusion, NiNfusion_IR, NiNfusion_RGB, \
    SSF, Add, Iterative_Differential_TransformerFusionBlock
    ...
    def __init__(self,
        ...
        if TWO_STREAM_SHARE_NECK:
            ...
            self.tfb_blocks = nn.ModuleList([     # (256, 64, 80), (512, 32, 40), (1024, 16, 20), (2048, 8, 10)           对于yolo640输入，原始特征图80, 40, 20 -> 20, 16, 10
                ...
                # Iterative_Differential_TransformerFusionBlock_RGB(1024, 40, 40)
                # Iterative_Differential_TransformerFusionBlock_IR(1024, 40, 40)
                # NiNfusion_IR(1024)
                # NiNfusion_RGB(1024)
                # Iterative_Differential_TransformerFusionBlock_ADD(1024, 40, 40)
                # Iterative_Differential_TransformerFusionBlock_crossV(1024, 40, 40)
